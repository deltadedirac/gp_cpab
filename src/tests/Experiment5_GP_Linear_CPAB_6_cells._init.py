...
if __name__ == "__main__":
    ...
    print(__package__)
    '''---------------------------------------------------------'''
    std = configManager("../../configs/setup3.yaml")
    ...
    path_preexist_model = std.parserinfo('*/Path_Preexist_Modellinear_experiment5')
    path_preexist_modelGP = std.parserinfo('*/Path_Preexist_ModelGP_experiment5')
    ...
    ''' FOR THETA DIM =6, FOR 6 CELLS AND CASESE 4, 10, USE THE DEFAULT'''
