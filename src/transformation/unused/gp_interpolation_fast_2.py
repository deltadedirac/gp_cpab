...
from .gp_setup_fast_2 import BatchIndependentMultitaskGPModel
...
class gp_interpolation(gp_interpolation):
    ...
    def sets_MultioutputGP_per_batches(self, x, data_sampled, batches):
        ...
        # Adapt input to get the shape [batch, n points, 1] in order to be processed by GP
        x = x.unsqueeze(2)
    ...
    def predict_operation(self, 
        ...
        test_x =  test_points.squeeze(1).unsqueeze(2)  # [batches, test_points, features]
